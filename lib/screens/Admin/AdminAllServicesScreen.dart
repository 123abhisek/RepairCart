...
class _AllServicesScreenState extends State<AdminAllServicesScreen>
            ...
            slivers: [
                ...
                sliver: SliverToBoxAdapter(
                  child: Material(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        _servicesFuture.then(
                            (services) => _filterServices(value, services));
                      },
                    ),
                  ),
                ),
              ...
              FutureBuilder<List<dynamic>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final services =
                      _isSearching ? _filteredServices : snapshot.data!;
                  final itemCount =
                      services.isEmpty && _isSearching ? 1 : services.length;
